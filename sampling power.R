...
popsize = 2000000
collects = recollects = c(seq(500, 5000, 500))
...
#plot data nicely
off = 100
plot(-1000, -1000, xlim=c(0, max(collects*2)), ylim=c(0,2500000), xlab="total number of samples genotyped per year", ylab="estimated population size")
segments(x0=0, x1=max(collects*2), y0=popsize, y1=popsize, lty=2, col="grey50")
...
segments(x0=c(o$totalgenos - off), x1=c(o$totalgenos + off), y0=o$NstM-o$NstSE, y1=o$NstM-o$NstSE, col=alpha("firebrick3", 0.8))
segments(x0=c(o$totalgenos - off), x1=c(o$totalgenos + off), y0=o$NstM+o$NstSE, y1=o$NstM+o$NstSE, col=alpha("firebrick3", 0.8))
segments(x0=o$totalgenos, x1=o$totalgenos, y0=o$NstM-o$NstSE, y1=o$NstM+o$NstSE, col=alpha("firebrick3", 0.8))
